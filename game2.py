...
class Brick(GameObject):
    COLORS = {1: '#999999', 2: '#555555', 3: '#222222'} # Colours of the bricks according to the number of hits

    def __init__(self, canvas, x, y, hits):
        self.width = 75
        self.height = 20
        self.hits = hits
        color = Brick.COLORS[hits]  # the colour of the brick
        item = canvas.create_rectangle(x - self.width / 2,
                                       y - self.height / 2,
                                       x + self.width / 2,
                                       y + self.height / 2,
    ...
    def hit(self):
        ...
        if self.hits == 0:
            ...
            self.canvas.itemconfig(self.item,
                                   fill=Brick.COLORS[self.hits])    # change the colour of the brick
